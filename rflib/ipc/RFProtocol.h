...
class SuspectFlow : public IPCMessage {
    public:
        SuspectFlow();
        SuspectFlow(uint8_t mod, uint64_t vm_id, uint64_t dp_id, uint32_t vm_port, std::vector<Match> matches, string ip_src, string gateway);
...
class IptablesRegister : public IPCMessage {
    public:
        IptablesRegister();
        IptablesRegister(uint64_t vm_id, uint32_t vm_port, MACAddress hwaddress, string blocked_ip);
        ...
        string get_blocked_ip();
        void set_blocked_ip(string blocked_ip);
...
class IptablesRegisterDynamic : public IPCMessage {
    public:
        IptablesRegisterDynamic();
        IptablesRegisterDynamic(uint64_t vm_id, uint32_t vm_port, string blocked_ip);
